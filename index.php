...
<body>
   ...
   <section class="section-meals">
    ...
    <div class="row">
        ...
        <div class="col span-1-of-4 box">
            <img src="resources/img/lisbon-3.jpg" class="cities-img" alt="Lisbon">
        <h3>Lisbon</h3>
           ...
           <div class="col span-1-of-4 box">
            <img src="resources/img/san-francisco.jpg" class="cities-img" alt="San Francisco">
        <h3>San Francisco</h3>
            <div class="city-feature">
                 <i class="ion-ios-people-outline icon-small"></i>
                3700+ happy eaters
            ...
            <div class="col span-1-of-4 box">
            <img src="resources/img/berlin.jpg" class="cities-img" alt="Berlin">
        <h3>Berlin</h3>
            <div class="city-feature">
                 <i class="ion-ios-people-outline icon-small"></i>
                2300+ happy eaters
            ...
            <div class="col span-1-of-4 box">
            <img src="resources/img/london.jpg" class="cities-img" alt="London">
        <h3>London</h3>
            <div class="city-feature">
                 <i class="ion-ios-people-outline icon-small"></i>
                1200+ happy eaters
    ...
    <div class="row">
        <div class="col span-1-of-3">
            ...
            <cite><img src="resources/img/customer-1.jpg" alt="Image of Alberto Duncan">Alberto Duncan</cite>
            </blockquote>
        </div>
        ...
        <div class="col span-1-of-3">
            ...
            <cite><img src="resources/img/customer-2.jpg" alt="Image of Joana Silva">Joana Silva</cite>
            </blockquote>
        </div>
        ...
        <div class="col span-1-of-3">
            ...
            <cite><img src="resources/img/customer-3.jpg" alt="Image of Milton Chapman">Milton Chapman</cite>
            </blockquote>
        </div>
    ...
    <footer>
        ...
        <div class="row">
        <p>
            Copywrite &copy; 2020 by Omnifood. All rights reserved.
